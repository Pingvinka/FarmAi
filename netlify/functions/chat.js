...
exports.handler = async function (event) {
    ...
    try {
        ...
        const systemPrompt = `
Вы — профессиональный ИИ-ветеринар и консультант системы "ФермAi". Ты консультируешь фермера, который владеет козами, свиньями, коровами, лошадьми, овцами. 
...
6. В диалоге есть история предыдущих сообщений, используйте её для поддержания контекста беседы.

КОНТЕКСТ О ЖИВОТНОМ И ИСТОРИЯ ДИАЛОГА:
${context || 'Нет данных о конкретном животном. Отвечайте как общий ветеринарный консультант.'}
        ...
        const response = await fetch('https://openrouter.ai/api/v1/chat/completions', {
            ...
            body: JSON.stringify({
                ...
                temperature: 0.7,
                max_tokens: 500  // ✅ Увеличено с 350 до 500
            })
        });
